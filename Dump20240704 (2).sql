...
INSERT INTO `actividades` VALUES (1,'1','2024-07-10','socialización',0,0,0,0,0,0);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `obtenerDatosCompletos` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtenerDatosCompletos`()
BEGIN
    SELECT 
		b.id_beneficiado,
...
-- Dump completed on 2024-07-04 16:02:22
